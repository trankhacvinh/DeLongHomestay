(function () {
    ...
    Vue.createApp({
        ...
        methods: {
            ...
            openDay(day) { const today = new Date().toISOString().slice(0,10); this.editor = {open:true,id:day?.id || null,error:'',form: day ? clone(day) : {startDate:today,endDate:today,name:'',category:0,basePriceProfile:0,surchargePercent:10,bookingMode:0,allowThreeSlotCombo:true,note:'',isActive:true}}; },
