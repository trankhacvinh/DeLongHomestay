        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    normalized_phone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    email = table.Column<string>(type: "character varying(254)", maxLength: 254, nullable: true),
                    identity_number = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "f_k_customers_properties_property_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_user_property_accesses", x => new { x.user_id, x.property_id });
                    table.ForeignKey(
                        name: "f_k_user_property_accesses_asp_net_users_user_id",
                        column: x => x.user_id,
                        principalTable: "asp_net_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "f_k_user_property_accesses_properties_property_id",
                        column: x => x.property_id,
                        principalTable: "properties",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    room_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    extra_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "f_k_bookings_customers_customer_id",
                        column: x => x.customer_id,
                        principalTable: "customers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "f_k_bookings_properties_property_id",
                        column: x => x.property_id,
                        principalTable: "properties",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_room_rates", x => x.id);
                    table.ForeignKey(
                        name: "f_k_room_rates_rooms_room_id",
                        column: x => x.room_id,
                        principalTable: "rooms",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_bookings_customer_id",
                table: "bookings",
                column: "customer_id");

            migrationBuilder.CreateIndex(
                name: "i_x_bookings_property_id_code",
                table: "bookings",
                columns: new[] { "property_id", "code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "i_x_bookings_property_id_status",
                table: "bookings",
                columns: new[] { "property_id", "status" });

            migrationBuilder.CreateIndex(
                name: "i_x_bookings_room_id_check_in_utc_check_out_utc",
                table: "bookings",
                columns: new[] { "room_id", "check_in_utc", "check_out_utc" });

            migrationBuilder.CreateIndex(
                name: "i_x_customers_property_id_name",
                table: "customers",
                columns: new[] { "property_id", "name" });

            migrationBuilder.CreateIndex(
                name: "i_x_customers_property_id_normalized_phone",
                table: "customers",
                columns: new[] { "property_id", "normalized_phone" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "i_x_properties_code",
                table: "properties",
                column: "code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "i_x_room_rates_room_id",
                table: "room_rates",
                column: "room_id");

            migrationBuilder.CreateIndex(
                name: "i_x_rooms_property_id_code",
                table: "rooms",
                columns: new[] { "property_id", "code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "i_x_user_property_accesses_property_id",
                table: "user_property_accesses",
                column: "property_id");
