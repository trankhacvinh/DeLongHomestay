...
Foundation gồm Identity/PostgreSQL wiring; Property/Room/RoomRate/UserPropertyAccess; seed definition De Long + 6 phòng; Razor admin shell; Vue + `api.js` + antiforgery; Rooms feature mẫu; Customer + Booking core API/service; và CI restore/build/test.

Initial EF migration sẽ được tạo sau khi Customer/Booking model build pass bằng .NET SDK thật. Xem `docs/DEVELOPMENT.md`.
